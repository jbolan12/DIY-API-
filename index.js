...
app.patch('/jokes/:id', (req, res) => {
  ...
  currentJoke.jokeText = req.body.text ? req.body.text : currentJoke.jokeText;
  currentJoke.jokeType = req.body.type ? req.body.type : currentJoke.jokeType;
